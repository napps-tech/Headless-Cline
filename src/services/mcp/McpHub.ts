...
import { z } from "zod"
import { VscodeClineProvider, GlobalFileNames } from "../../core/webview/ClineProvider"
import {
	McpResource,
	McpResourceResponse,
	McpResourceTemplate,
...
export class McpHub {
	private providerRef: WeakRef<VscodeClineProvider>
	...
	constructor(provider: VscodeClineProvider) {
